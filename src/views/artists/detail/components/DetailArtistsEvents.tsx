...
type DetailArtistsEventsProps = {
  exhibitionsData: Exhibitions[];
  exhibitionsMetaData: Meta;
  onExhibitionSeeMore: () => void;
};
...
const DetailArtistsEvents: React.FC<DetailArtistsEventsProps> = ({
  exhibitionsData,
  exhibitionsMetaData,
  onExhibitionSeeMore,
}) => {
...
export default DetailArtistsEvents;
